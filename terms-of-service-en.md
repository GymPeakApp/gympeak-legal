...
- **Owner**: GymPeak dveloper (natural person), resident in Spain.
- **Contact**: appgympeak@outlook.com

## 2. Purpose

GymPeak is an iOS application that offers:
- A catalog of exercises and routines with educational content (descriptions, tips, illustrations).
- Generation of personalized training plans ("GymPeak Coach").
- Workout session tracking, history, and progress metrics.
- Optional syncing between your devices via iCloud.
...
You may not:
- Decompile, reverse-engineer, disassemble, or attempt to extract the source code.
- Use the App for commercial purposes (e.g., delivering paid classes using its contents exclusively).
- Copy, distribute, modify, or create derivative works of catalog contents (exercises, illustrations, educational prose) beyond the intended personal use.
- Circumvent the subscription system or technical protection measures.
...
- Your iOS device → Settings → [your name] → Subscriptions → GymPeak → Cancel.
- Or from within the App → Settings → Manage subscription.
...
- Not use the App in a way that violates third-party rights or applicable regulations.
- Not attempt to access systems or data you are not authorized to access.

## 8. Medical disclaimer (summary)

The App **does not constitute medical advice** nor replace consultation with a qualified healthcare professional. Before starting any training program, you must consult your doctor, especially if you have a medical condition, are pregnant, or have been inactive for a long time. See the [Medical Disclaimer](medical-disclaimer-en.md) document for full details.

## 9. Warranty disclaimer

The App is provided "as is" and "as available". To the maximum extent permitted by applicable law, **we do not warrant** that:
- The App is free from errors or interruptions.
- Your training results match your expectations.
- iCloud sync or subscriptions work without failures caused by third parties (Apple).
...
- Damages caused by willful misconduct or gross negligence on our part.
- Personal injury (physical harm) when it results from our breach of essential contract obligations, within the limits provided by law.
- Mandatory consumer rights recognized by Spanish and European legislation.

## 11. Suspension and termination

We may suspend or terminate your access to the App if:
- You materially breach these Terms.
- We detect fraudulent use of the subscription system.
...
The European Commission provides an alternative dispute resolution platform for consumers: [ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr).
